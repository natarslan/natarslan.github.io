...
<mark style="background: #ABF7F7A6;">Important: The iframe embed is visible in "reading mode" and not in "editing mode".</mark>
...
4. When you preview the note (reading mode), it should show the HTML inside an iframe.
